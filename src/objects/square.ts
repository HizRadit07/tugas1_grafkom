...
export function drawSquare(x,y, gl:WebGL2RenderingContext, program: WebGLProgram, objProps:any, color){
    ...
    if (objProps.n_points < 2){
        ...
        if (objProps.n_points == 2) {
            ...
            let remainingAttributes = generateSquareRemains(objProps, color)
...
function generateSquareRemains(objProps:any, clr) {
